    ...
    >
      ...
      <div id="pricing" data-section="pricing" className="scroll-mt-24">
        <div className="mx-auto px-4 md:px-6">
          <PricingCardOne
            plans={[
              { id: 'basic', price: '$29/mo', subtitle: 'Great for small teams', features: ['5 users', 'Basic support'], badge: 'Basic' },
              { id: 'pro', price: '$99/mo', subtitle: 'For growing businesses', features: ['10 users', 'Premium support'], badge: 'Pro' }
            ]}
